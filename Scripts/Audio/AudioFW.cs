...
public class AudioFW : MonoBehaviour {
    ...
    public static void PlayNoOverlap(string id) {
        instance.PlayNoOverlapImpl(id);
    }
    ...
    public static bool IsLoopPlaying(string id) {
        return instance.IsLoopPlayingImpl(id);
    }
    ...
    void PlayNoOverlapImpl(string id) {
        if (!sfx.ContainsKey(id)) {
            Debug.LogError("No sound with ID " + id);
            return;
        }
    ...
    bool IsLoopPlayingImpl(string id) {
        if (!loops.ContainsKey(id)) {
            Debug.LogError("No sound with ID " + id);
            return false;
        }
